...
public class Program {
	public static void Main(string[] args) {
		...
		try {
			...
			var advancedReport = new AdvancedReportService(cleanedEntries);
			advancedReport.PrintTotalHoursPerEmployee();
			Console.WriteLine();
			advancedReport.PrintTotalHoursPerProject();
			Console.WriteLine();
			advancedReport.PrintTopEmployees(2);
			Console.WriteLine();
			advancedReport.PrintAverageHoursPerDay();
			Console.WriteLine();
			advancedReport.PrintHoursPerEmployeePerProject();
